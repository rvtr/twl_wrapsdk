...
/* UCODE, JIS */
const u16 ucode2jis[NUMUNICHARS][2] = {
...
/* JIS UCODE */
const u16 jis2ucode[NUMJISCHARS][2] = {
...
#define UNICODEDEFAULTCHAR (u16) 0x005f /* '_' UNICODE_UNDERBAR */
...
u8 c;
u16 w, w1;
u16 j; /* JIS character as a halfword */

    /* Convert JIS to halfword. Use one or two bytes of JIS */
...
int low, high, midpoint;
u16 w,w1;
u16 u; /* Unicode character we want to convert to JIS */
