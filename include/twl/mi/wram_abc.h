...
#define MI_WRAM_A_SIZE_MAX    (MI_WRAM_A_BLOCK_SIZE * MI_WRAM_A_BLOCK_NUM)  // 256KB or 128KB
#define MI_WRAM_B_SIZE_MAX    (MI_WRAM_B_BLOCK_SIZE * MI_WRAM_B_BLOCK_NUM)  // 256KB or 128KB
#define MI_WRAM_C_SIZE_MAX    (MI_WRAM_C_BLOCK_SIZE * MI_WRAM_C_BLOCK_NUM)  // 256KB or 128KB
